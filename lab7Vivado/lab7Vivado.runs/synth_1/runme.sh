...
HD_PWD='C:/Users/tejas/ECEN/lab7/lab7Vivado/lab7Vivado.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tld.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tld.tcl
