...
HD_PWD='C:/Users/tejas/ECEN/lab7/lab7Vivado/lab7Vivado.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tld.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tld.tcl -notrace
